...
void test_memory_base_stack_push(size_t start, size_t end) {
  ...
  for (size_t i = start; i <= end; ++i) {
    ...
    for (elem_t id = 1uz; id <= B; ++id) {
      ...
      for (size_t k = 0uz; k < data_size / B; ++k) {
...
int main() { test_memory_base_stack_push(15uz, 15uz); }